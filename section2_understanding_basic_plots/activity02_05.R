...
p + geom_boxplot() + 
  ggtitle("box plot of diamond prices given their cut")

# Example 02
# boxplot of a diamond's price given its cut
p + geom_boxplot(notch = TRUE) + 
  ggtitle("boxplot of diamond prices given their cut, with notch")

# Example 03
# boxplot with notch, 
p + geom_boxplot(aes(fill = clarity), notch=TRUE) + 
  ggtitle("box plot of diamond prices given their cut and their clarity")
